        ...
        <div class="container mx-auto">
          <div class="max-w-3xl">
            ...
            <p class="text-lg text-gray-700 mb-4">
              ...
              to the supplies like ready to eat baked biscuits, ready cream-less
              cakes, pulses, masalas, etc to grocery stores. Also, to few
              reputed large supermarket stores, Nabhas is supplying apparel like
              shirts and kurtas etc. Door mats, dupattas, umbrellas, lamps and
              stands, novelties, etc Team at Nabhas is catering to problem areas
              of these stories in optimizing quantities and returns.
            </p>
            <p class="text-lg text-gray-700 mb-4">
              It is expected that the grocery retail market in India will be
              reaching approximately $1.10 trillion by the year 2030. In view of
              its strategic importance in the Indian economy, we analyze the
              current status based on secondary data and predict some likely
              future scenarios. We consider the shift and share of the organized
              and unorganized retail in India, the level of digitization in
              India, the effect of the COVID-19 pandemic, and the Indian ethos
              and values in purchasing behavior.
            </p>
            <p class="text-lg text-gray-700">
              In 2010, the Indian community was skeptical about the survival of
              kirana stores because of the emergence of
              supermarkets/hypermarkets. However, more than a decade later,
              kirana and small stores are surviving due to the service specialty
              involving personal touch, monthly credit and proximity to the
              consumers. That said, growth in e-commerce and organized retail is
              witnessing post-COVID-19 with preferences for a hygienic
              environment as well as discounts and loyalty points offered by
              organized retailers. Another significant trend that has emerged is
              large retailers (Reliance 7-Eleven stores, Tata Fresho stores,
              D-Mart and many more) collaborating with local kirana stores to
              help manage efficient delivery and expand their networks. India's
              retail market contributes 10% to India's GDP and employs 8% of
              India's population.
            </p>
          </div>
        </div>
