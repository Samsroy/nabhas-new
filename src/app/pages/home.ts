...
@Component({
  ...
  template: `
    <div class="bg-gray-50">
      <!-- Hero Section -->
      <section class="bg-gradient-to-r from-[#1a2a5e] to-[#2d3f7f] text-white py-20">
        ...
        <div class="container mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
              ...
              <div class="p-6">
                <h3 class="text-xl font-bold text-gray-900 mb-2">Printed Cups</h3>
                <p class="text-gray-600">Custom printed paper cups for branded beverages and special events. Eye-catching designs.</p>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
              ...
              <div class="p-6">
                <h3 class="text-xl font-bold text-gray-900 mb-2">Tissue Rolls</h3>
                <p class="text-gray-600">Premium quality tissue rolls for homes and businesses. Soft, strong, and eco-friendly.</p>
              </div>
            </div>
