...
export class SeoService {
  ...
  resetMetaTags() {
    this.setPageTitle(
      "Nabhas | Smart Partners Smart Future - Innovative Solutions",
    );
    this.setPageDescription(
      "Nabhas offers innovative, sustainable packaging solutions across Disposables, Retail, Foods & Cafes, Technologies, and Healthcare.",
    );
    this.setPageKeywords(
      "Nabhas, disposables, retail, food cafe solutions, healthcare solutions, technology solutions, sustainable packaging",
    );
  }
}
